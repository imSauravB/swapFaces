...
#
# -*- coding:utf-8 -*-
# @Script: videoUtils.py
# @Author: imSauravB
# @Email: sauravkumarbehera@gmail.com
# @Create At: 2023-06-24 21:48:17
# @Last Modified By: imSauravB
# @Last Modified At: 2023-06-25 00:41:00
...
def detect_fps(input_path):
    ...
    if "/" in output:
        try:
            ...
            print("######################## Returning Detected pfs#################")
        except:
            pass
    print("######################## Returning Default pfs as 30 #################")
    return 30, 30
...
def create_video(video_name, fps, output_dir):
    ...
    os.system(f'ffmpeg -hwaccel cuda -framerate "{fps}" -i "{output_dir}{sep}%04d.png" -c:v libx264 -crf 7 -pix_fmt yuv420p -y "{output_dir}{sep}output.mp4"')
